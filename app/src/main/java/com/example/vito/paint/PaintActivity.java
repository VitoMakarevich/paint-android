...
import com.example.vito.paint.R;
...
public class PaintActivity extends AppCompatActivity
    ...
    private File createImageFile() throws IOException {
        ...
        File storageDir = new File(Environment.getExternalStorageDirectory() +
                "/Android/data/com.example.vito.paint/files/Pictures");
    ...
    private void showColorPickerDialog() {
        final ColorPicker cp = new ColorPicker(this, Color.red(this.color), Color.green(this.color), Color.blue(this.color));
    ...
    public void setColor(int color){
        this.color = color;
        this.setColorPickerIconColor(color);
        paintView.setColor(color);
    }
